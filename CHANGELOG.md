...
- Synchronizes Rocky Node.js packages (`nodejs`, `nodejs-libs`, `npm`, `c-ares`) before Playwright/npm execution and validates `node --version`/`npm --version` as the Hermes user.
