...
- `hermes_nginx_http_enabled`: enable an HTTP listener and HTTP-01 webroot support. Default: `false` (HTTPS-only)
- `hermes_nginx_letsencrypt_challenge_method`: ACME challenge method (`tls-alpn-01` or `webroot`). Default: `tls-alpn-01`
